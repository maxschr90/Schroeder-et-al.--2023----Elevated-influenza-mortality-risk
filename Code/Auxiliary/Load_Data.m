...
writematrix(Excess_Influenza,'../Code/SI_Figure_A2_Data.xlsx','Sheet','Influenza','Range','B2:I7')
writematrix(Excess_Resp,'../Code/SI_Figure_A2_Data.xlsx','Sheet','Respiratory','Range','B2:I7')
