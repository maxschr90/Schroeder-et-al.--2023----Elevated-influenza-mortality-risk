...
% Calculate Average Main Wave Mortality for England & Wales
...
% Calculate Outbreak Risk for different thresholds
ttt =[1:9,12];
for n=1:10
    i=ttt(n);
...
% Calculate the inverted CDF of the bounded pareto to get probability bands
for b = 1:8
...
ax.FontSize =8;
ax.XTickLabelRotation = 0;
title({'England & Wales', '1890-91'},'fontsize',6,'FontWeight','bold')
box off
